<template>
  <div>
    <ProjectBanner
      :project-bg="projectBg"
      :title="title"
      :text-content="textHolder"
      :main-text-content="mainTextContent"
    ></ProjectBanner>
    <VideoContainer :video-urls="videoUrls"></VideoContainer>
  </div>
</template>
...
import VideoContainer from '@/components/VideosContainer.vue'
...
const mainTextContent =
  'Trong quá trình công tác tại Tôn Pomina, tôi có cơ hội đi thực tế tại nhiều vùng miền khác nhau. Những trải nghiệm này giúp tôi hiểu rõ hơn nhu cầu, hành vi và cách tiếp nhận thông tin của khách hàng, đồng thời tôi nhận ra rằng việc thấu hiểu văn hóa đại chúng, văn hóa địa phương là yếu tố quan trọng để xây dựng nội dung truyền thông phù hợp và  hiệu quả.'
</script>
